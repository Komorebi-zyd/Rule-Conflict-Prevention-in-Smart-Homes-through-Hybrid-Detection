...
\begin{systempromptbox}{LLM Initial Prompt: Smart Home Conflict Mitigation Expert}
	...
	\textit{Precedence Note:} For Action Conflicts, status is updated based on execution order.
	...
	\textit{\footnotesize (Applies to Action \& Indirect Action Conflicts)}
	...
	\textit{\footnotesize (Applies to Trigger/Condition \& Indirect types)}
