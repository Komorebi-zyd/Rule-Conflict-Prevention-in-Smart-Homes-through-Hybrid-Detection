...
\begin{itemize}
	\item For Trigger Interaction and Indirect Trigger Interaction, the focus is on whether the $sf$ of the second rule is greater than zero. If it is less than zero, it is determined to be a rule conflict.
